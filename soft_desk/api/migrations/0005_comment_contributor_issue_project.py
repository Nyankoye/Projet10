...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('permission', models.CharField(blank=True, choices=[('Création', 'Création'), ('Lecture', 'Lecture'), ('Modification', 'Modification'), ('Suppression', 'Suppression')], max_length=100, null=True)),
